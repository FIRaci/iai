...
const catDescriptions: Record<string, string> = {
  ...
  "other-tools": "Công cụ phát triển, tiện ích lập trình, và various dev utilities",
  ...
  "data-datasets": "Datasets, data collections, và nguồn dữ liệu cho ML/AI",
  "data-processing": "Xử lý dữ liệu với pandas, Spark, và ETL pipelines",
  "datasets": "Dataset management, labeling tools, và data annotation platforms",
  "fine-tuning": "Fine-tuning LLMs và mô hình ngôn ngữ với PEFT, LoRA, và RLHF",
  "benchmarking": "Benchmark và đánh giá hiệu năng mô hình AI/ML",
  "mlops": "MLOps platforms, experiment tracking, và model lifecycle management",
  "deployment": "Deploy ML models lên production với serving frameworks và Kubernetes",
  "model-hubs": "Model hubs, registry, và nơi chia sẻ pre-trained models",
  "dev-infra": "Developer infrastructure, version managers, và runtime alternatives",
  "editors": "IDEs, text editors, và code editing tools cho developers",
  "ide-plugins": "IDE extensions, plugins, và AI coding assistants tích hợp",
  "cli-tools": "CLI utilities, terminal tools, và command-line helpers",
  "terminals": "Terminal emulators, shell environments, và console tools",
  "git-tools": "Git clients, GUI tools, và version control utilities",
  "monitoring": "Monitoring, alerting, và infrastructure observability tools",
  "automation": "Workflow automation, CI/CD pipelines, và task orchestration",
  "embeddings": "Embedding models, vector generation, và semantic search tools",
  "tools": "Developer tools, utilities, và programming helpers",
  "productivity": "Productivity tools, knowledge management, và workflow optimization",
  "apis": "API development, testing, documentation, và integration tools",
}
