...
const navItems: NavGroup[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { title: "Air (JetBrains)", path: "/ai-tools/air-jetbrains" },
      { title: "Amp", path: "/ai-tools/amp" },
      ...
      { title: "Codex", path: "/ai-tools/codex" },
      ...
      { title: "JetBrains AI", path: "/ai-tools/jetbrains-ai" },
      { title: "JetBrains Junie", path: "/ai-tools/junie" },
      ...
      { title: "Qodo", path: "/ai-tools/qodo" },
      { title: "Replit Agent", path: "/ai-tools/replit-agent" },
      { title: "Replit", path: "/ai-tools/replit" },
      ...
      { title: "Tabnine", path: "/ai-tools/tabnine" },
      { title: "Tembo", path: "/ai-tools/tembo" },
  ...
  },
  {
    ...
    children: [
      ...
      { title: "LambdaTest", path: "/testing/lambdatest" },
  ...
  },
  {
    ...
    children: [
      ...
      { title: "CodeScene", path: "/security/codescene" },
  ...
  },
  {
    ...
    children: [
      ...
      { title: "Gemini Code Assist", path: "/dev-tools/gemini-code-assist" },
